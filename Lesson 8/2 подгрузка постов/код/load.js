...
function insertPosts() {
    ...
    // Циклом управляем сколько сразу получить постов. Можно и без цикла. Пусть будет 5 постов
    let postsMarkup = '';
    for (let i = 0; i < 5; i++) {
...
function getPostMarkup(counter) {
    ...
    */
    ...
    // Как сказано в видео new Date().getTime() + counter - это просто генератор картинок на сайте
