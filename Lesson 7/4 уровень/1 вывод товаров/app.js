...
const class_products = document.querySelector('.products');
...
function showCategory(category) {
    ...
    let products_txt = '';
    products[category].forEach(product => products_txt += getProductMarkup(product));
    class_products.innerHTML = products_txt;
...
document.querySelectorAll('button').forEach(element => element.addEventListener('click', clickHandler));
